const doctorModule = require("../models/doctorModel");
...
const updateProfileController = async (req, res) => {
  try {
    const doctor = await doctorModule.findOneAndUpdate(
...
const updateStatusController = async (req, res) => {
  try {
    ...
    const user = await doctorModule.findOne({ _id: appointments.userId });
